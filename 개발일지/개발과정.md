...
## (4) 무기 압수 기능 구현
- 적 오브젝트는 무기를 들고 시작하고 플레이어는 grab을 통해 이 무기를 빼앗아 사용 할 수 있다
- 다만, 무기를 뺏자마자 그 총의 collider와 충돌로 인해 적이 사망처리되는 문제가 발생
- + 오브젝트가 적의 부모관계에 있기 때문에 던질 수 없는 문제 또한 발생
- 이를 해결하기 위해 select enter/exit 이벤트와 bool 변수를 통하여 플레이어가 그랩하였을 때 변수에 변화를 주고 부모관계를 해제하였음
- 또한 적의 자식이었기 때문에 kinematic이 true로 되어 있는 것을 false로 전환해주었음
  <br>![image](https://github.com/user-attachments/assets/52b75890-d33a-43c4-a921-c997726d71f9)
- 이로써 플레이어가 해당 무기를 자유롭게 사용할 수 있고 적이 사망하여 사라지더라도 grab했을 경우에는 계속 사용 할 수 있게 됨

## (5) 사망 구현
- 적이 데미지를 입었을 경우 1초후(자유롭게 변경) 사망처리
- 적의 신체가 남아있을 경우 플레이어의 움직임과 navMesh의 자연스러운 움직임에 방해가 될 수 있음
- 공격 가능한 오브젝트에 아래 로직을 부여함으로써 enemy의 bool 변수를 전환
<br>![image](https://github.com/user-attachments/assets/cb9c72f5-0d36-463e-bed9-0f7f20d4a361)
<br>![image](https://github.com/user-attachments/assets/d893e65b-495b-417c-a8f8-bf9d306572a0)
<br>![image](https://github.com/user-attachments/assets/be9de8fe-68cb-4ee6-9428-3cb41f8e9158)
